...
# finds the length of the  longest_consecutive_sequence (i.e., sequence 
# of integers in which each element is one greater than the previous element).
...
def longest_consecutive_sequence(nums):
   ...
   for num in nums:
      ...
      if num - 1 not in num_set:
         ...
         # Keep incrementing the current number until 
